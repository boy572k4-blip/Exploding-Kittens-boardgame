...
if (USE_DISCORD) {
    ...
    if (roomIdFromUrl && storedPlayerName && storedAvatar) {
        ...
        (async () => {
            ...
            try {
                // FIXED: Simply rejoin with same displayName - server will recognize us
                ...
                try {
                    ...
                    console.log(`[ExplodingKittens] Successfully rejoined room!`);
                } catch (joinError) {
                    console.error(`[ExplodingKittens] Failed to rejoin room:`, joinError);
                    throw joinError;
                }
